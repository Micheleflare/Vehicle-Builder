      ...
      .prompt([
        {
          ...
          choices: ['Car', 'Truck', 'Motorbike'], // Update choices
        },
      ])
      .then((answers) => {
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (answers.vehicleToTow.vin === truck.vin) {
          console.log("Hey you can't tow that ")
        } else {
    ...
    inquirer
      ...
      .then((answers) => {
        if (answers.action === 'Print details') {
          ...
          let selectedVehicle: Truck | undefined;
          // selectedVehicle = this.vehicles.find(v => v.vin === this.selectedVehicleVin);
          for (let i = 0; i < this.vehicles.length; i++){
            if (this.vehicles[i].vin === this.selectedVehicleVin && this.vehicles[i] instanceof Truck){
              selectedVehicle= this.vehicles[i] as Truck
            }
          }
          if (selectedVehicle ) {
            ...
            return
              ...
              console.log("No vehicle selected for towing.");
            }
            return; // Avoid calling performActions immediately
          }

        else if (answers.action === 'wheelie') {
          // Check if the selected vehicle is a motorbike
          let selectedVehicle : Motorbike | undefined;
          for (let i = 0; i < this.vehicles.length; i++){
            if (this.vehicles[i].vin === this.selectedVehicleVin && this.vehicles[i] instanceof Motorbike){
              selectedVehicle= this.vehicles[i] as Motorbike
            }
          }
          if (selectedVehicle ) {
